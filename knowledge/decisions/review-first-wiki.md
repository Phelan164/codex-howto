...
> Sources: `official-codex-manual`, `karpathy-llm-wiki-gist`, `astro-karpathy-llm-wiki`, `lucas-llmwiki`, `atomicstrata-llm-wiki-compiler`
...
The Astro-Han implementation shows that the core ingest, query, and lint loop
can be packaged as a portable skill. The lucasastorian and atomicstrata
implementations demonstrate valuable future capabilities such as MCP access,
search indexes, citation graphs, review queues, freshness tracking, and
evaluation, but their platform complexity is not required at this repository's
current scale.
...
- Ingest and promotion are explicit operations.
