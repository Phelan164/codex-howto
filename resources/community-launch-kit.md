...
| 2026-08-17 | GitHub Traffic | [Weekly adoption experiment](adoption-experiment-2026-08-17.md) | Pre-routing 14-day baseline | 287 | 70 unique | 2 | 1 | 3 open | — | 382 clones from 123 unique cloners; leading referrers were GitHub 56/28 unique, OpenAI Community 53/6, and the benchmark site 50/16; test clearer first-visit routing before opening more directory PRs |
| 2026-08-26 | GitHub Traffic | [Repository](https://github.com/Phelan164/codex-howto) | 14-day adoption checkpoint | 193 | 64 unique | 3 | 1 | 3 open | 0 reported | 308 clones from 91 unique cloners; GitHub led referrals with 27 unique visitors, followed by ChatGPT with 4 and OpenAI Community and Google with 3 each; stars increased by one since 2026-08-17, forks remained flat, and no external benchmark replication was reported |
| 2026-08-26 | DEV Community | [When should Codex use multiple agents? A benchmark, not a slogan](https://dev.to/tam_nguyenvan_1f689d35bc9/when-should-codex-use-multiple-agents-a-benchmark-not-a-slogan-4fp8) | Standalone measurement article | — | — | 3 | 1 | — | — | Published with `openai`, `opensource`, `testing`, and `ai` tags; explains the bounded ownership rule, smoke evidence, limitations, controller contract, and replication protocol without claiming general speed or token savings |
