...
REQUIRED_MEASUREMENT_FILES = {
    ...
    "labs/incident-response-benchmark/AGENTS.md",
    "labs/incident-response-benchmark/README.md",
    "labs/incident-response-benchmark/TASK.md",
    "labs/incident-response-benchmark/evaluator.py",
    "labs/incident-response-benchmark/checks/store_probe.py",
    "labs/incident-response-benchmark/test/test_store.py",
    "examples/templates/orchestration-run-receipt.md",
    "examples/measurements/incident-orchestration-smoke-2026-08-11.md",
    "scripts/tests/test_incident_evaluator.py",
